...
xcopy .\dist\MinSizeRel\bin .\dist\runtime-cli /s /i || goto :error
...
xcopy .\dist\MinSizeRel\bin .\dist\runtime-dynamic /s /i || goto :error
...
xcopy .\dist\MinSizeRel\bin .\dist\runtime-static /s /i || goto :error
